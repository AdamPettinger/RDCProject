...
for i=1:s(3)
    % x-axis
    lines(3*i) = line([G(1,1,i), G(1,2,i)], [G(2,1,i), G(2,2,i)], [G(3,1,i), G(3,2,i)], 'color', 'yellow', 'linewidth', 1);
    lines(3*i+1) = line([G(1,1,i), G(1,3,i)], [G(2,1,i), G(2,3,i)], [G(3,1,i), G(3,3,i)], 'color', 'cyan', 'linewidth', 1);
    lines(3*i+2) = line([G(1,1,i), G(1,4,i)], [G(2,1,i), G(2,4,i)], [G(3,1,i), G(3,4,i)], 'color', 'magenta', 'linewidth', 1);
end
end
